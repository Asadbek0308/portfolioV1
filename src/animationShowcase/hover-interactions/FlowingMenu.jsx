...
export default function FlowingMenu({
  ...
  return (
    <div className="w-full h-full min-h-[600px] relative overflow-hidden" style={{ backgroundColor: bgColor }}>
...
function MenuItem({ 
  ...
  return (
    <div
      className="flex-1 relative overflow-hidden text-center min-h-[100px] w-full"
      ref={itemRef}
